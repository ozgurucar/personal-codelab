...
//     {
//         Console.Clear();
//         Console.WriteLine("Terminal resized, exiting...");
//         break;
//     }
//     Move();
// }
...
//     Console.SetCursorPosition(playerX, playerY);
//     Console.Write(player);
//     if (playerY == foodY && 0 >= foodX - playerX && foodX - playerX >= -3)
//     {
//         int currFood = food;
//         Console.SetCursorPosition(foodX, foodY);
//         for (int i = 0; i < Math.Abs(foodX - playerX); i++)
//         {
//             Console.Write(' ');
//         }
//         ShowFood();
//         if (currFood == 2) FreezePlayer();
