        ...
        case "3":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: " && (ourAnimals[i, 2] == "Age: ?" || ourAnimals[i, 2] == "Age: "))
                {
                    ...
                    Console.WriteLine($"Animal with" + ourAnimals[i, 0]);
                    do
                    {
                        Console.WriteLine("Enter valid age for this animal: ");
                        readResult = Console.ReadLine();
                ...
                if (ourAnimals[i, 0] != "ID #: " && (ourAnimals[i, 4] == "Physical description: "))
                {
                    ...
                    do
                    {
                        ...
                        Console.WriteLine("Enter a valid physical information for this pet");
